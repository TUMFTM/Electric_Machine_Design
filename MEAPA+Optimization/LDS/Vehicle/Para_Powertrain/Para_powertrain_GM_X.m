function [vehicle] = Para_powertrain_GM_X(vehicle, FZD_LDS)
...
% vehicle.GEARBOX{3}.eff              = ; % efficiencies in -;  [eff1.gear  eff2.gear ... effn.gear]
% 
% % Motor rear 1
% motor.type       = ;        % PSM or ASM
% motor.power      = ;           % in kW
...
% motor.U_n        = ;          % in V
% % Generate the motor data with motor tool:
% vehicle.MOTOR{3} = GENERATE_motor_efficiency_map(motor);
