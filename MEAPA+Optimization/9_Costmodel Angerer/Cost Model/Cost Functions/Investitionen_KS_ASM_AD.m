%Definition of the investment costs for an ASM for small batch production.
...
BAZ=400000;
Reinigungsanlage=78000;
Stanzanlage=1000000;
Paketieranlage=1400000;
Isolieranlage=200000;
Wickelautomat=1000000;
...
t_WI=210; %cycle time winding
t_BAN=400; %cycle time machining
...
Invest_W=Formgebung_W+Haerten_W+BAZ_W+Reinigung_W;
...
t_AM=850; %cycle time mounting part assembly
t_ET=200; %cycle time final inspection
...
clearvars Anbauteilmontage_EM Bandagierung_ST BAZ_BP BAZ_GH BAZ_W...
    ...
    Pruefanlage_ST Druckguss_RT Reinigunganlage Reinigungsanlage Rotormontage...
