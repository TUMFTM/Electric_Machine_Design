%Definition of the investment costs for a PSM for large-scale production.
...
t_RE=250; %Cleaning cycle time
t_VK=100; %cycle time linking
...
t_MG=135; %Takt time magnet assembly
t_WM=300; %cycle time shaft assembly
t_UW=120; %cycle time unbalance test
t_VK=100; %cycle time linking

Anzahl_Maschinen_MG_RT=ceil(t_MG/t_EM);
...
Invest_RT=Magnetbest_RT+Wellenmontage_RT+Unwucht_RT+Verkettung_RT;
