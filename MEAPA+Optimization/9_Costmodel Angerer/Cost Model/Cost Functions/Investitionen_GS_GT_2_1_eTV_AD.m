%Definition of investment costs for a gearbox large-scale production
%Transmission 2-stage 1-speed incl. eTV
%Data in €
...
t_DG=200; %cycle time die casting
t_EG=200; %cycle time trimming press
t_BAZ=600; %cycle time machining
...
t_FG=200; %cycle time forming
t_RH=140; %cycle time surface hardening
t_BAZ=1000; %cycle time machining
t_RE=600; %Cleaning cycle time
t_UW=150; %cycle time interlinking
...
t_FG=400; %Takt time shaping
t_WF=2500; %cycle time gear hobbing
t_RM=1500; %Broaching cycle time
t_RE=320; %Cleaning cycle time
t_HA=180; %cycle time induction hardening
t_SL=2050; %cycle time grinding
...
t_ZR=2100; %Takt time gear assembly
t_LA=2200; %cycle time bearing assembly
t_AM=2000; %Takt time mounting part assembly
t_ET=180; %cycle time final inspection
