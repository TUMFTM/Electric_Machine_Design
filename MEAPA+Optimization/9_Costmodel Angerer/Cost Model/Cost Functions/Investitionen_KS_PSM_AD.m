%Definition of the investment costs for a PSM for small batch production.
%Detailed source information for each individual machine in the
%Data in €
...
t_BAZ=180; %Takt time processingg
