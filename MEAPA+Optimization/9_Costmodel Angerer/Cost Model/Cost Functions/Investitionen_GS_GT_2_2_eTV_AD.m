...
%Transmission 2-stage 2-speed incl. eTV
%Data in €
...
t_WF=2800; %cycle time gear hobbing
t_RM=1700; %Broaching cycle time
t_RE=320; %cycle time cleaning
t_HA=200; %cycle time induction hardening
t_SL=2250; %cycle time grinding
...
t_ZR=2300; %Takt time gear assembly
t_LA=2200; %cycle time bearing assembly
t_AM=2200; %Takt time mounting part assembly
t_ET=180; %Takt time final inspection
