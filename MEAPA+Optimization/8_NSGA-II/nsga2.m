...
% global variables
global STOP_NSGA;   %STOP_NSGA : used in GUI , if STOP_NSGA~=0, then stop the optimization
STOP_NSGA = 0;
...
% default value for improvmeent ratio
impr_ratio_stop = 1;
impr_ratio = zeros(1,opt.maxGen);
impr_ratio(1) = 1;
