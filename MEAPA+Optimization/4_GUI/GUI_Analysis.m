...
% GUI_ANALYSE MATLAB code for GUI_Analysis.fig
...
% Last Modified by GUIDE v2.5 02-Jul-2019 14:37:06
...
listing = dir(['3_Results/',handles.Entwurf.Optionen.folder_id,'/2_Analysis']);
...
if(~isempty(listing))
    ...
    handles.default_opt.n_tics = 160;
    handles.default_opt.M_tics = 160;
...
% Set GUI
handles.text_ID.String = ['ID: Analysis_' handles.Entwurf.Optionen.file_id '_v' num2str(handles.opt.Count)];
...
switch button 
    case 'Ja'
        ...
        handles.default_opt.P_vzus = 1;
        handles.default_opt.Generator = 0;
        handles.default_opt.n_max = 12000;
        handles.default_opt.n_tics = 160;
        handles.default_opt.M_tics = 160;
        handles.default_opt.u_1max = handles.Entwurf.EMAG.U_1Str * sqrt(2);
        handles.default_opt.i_1max = handles.Entwurf.EMAG.I_1Str * sqrt(2);
...
[file,path] = uigetfile('*.mat',['3_Results/',handles.Entwurf.Optionen.folder_id,'/2_Analysis/']);

if isequal(file,0)
    % disp('Vorgang abgebrochen');
else
    %disp(['User selected ', fullfile(path,file)]);
    if(~strcmp(path,[pwd,'/3_Results/',handles.Entwurf.Optionen.folder_id,'/2_Analysis/']))
...
if(isfile(['3_Results/',handles.Entwurf.Optionen.folder_id,'/2_Analysis/Analyse_',handles.Entwurf.Optionen.file_id,'_v',num2str(handles.opt.Count),'.mat']))
...
% Save struct Analyse
try
    save(['3_Results/',handles.Entwurf.Optionen.folder_id,'/2_Analysis/Analyse_',handles.Entwurf.Optionen.file_id,'_v',num2str(handles.opt.Count),'.mat'],'Analyse');
...
%% Longitudinal dynamics simulation Initialization
%Transfer to LDS
    ...
    %xlswrite(['3_Results/',folder_id, '/1_Entwurf','/Entwurf_',file_id,'.xlsx'],(struct2array(FZD_LDS))','LDS','C3:C9')
    ...
    Analyse = Maschinendaten.Analyse;
    save(['3_Results/',folder_id,'/2_Analysis/Analyse_',file_id,'.mat'],'Analyse');
    
    [FZG_LDS1, Optimierer] = RUN_simulation(LDS_values, handles_GUI_LDS, FZD_LDS,Maschinendaten); %turn off LDS
    disp(FZG_LDS1);
    Entwurf.Optimierer=Optimierer;
...
uiwait(msgbox({'Model approach Jordan: Calculation of the remagnetization losses via inductions and electrical sheet data sheets with the extension of the Steinmetz equations according to Jordan' '' 'Abschaetzung ueber verketteten Fluss: Berechnung der Ummagnetisierungsverluste ueber verketteten Fluss (nicht empfohlen, sehr ungenau)'},'Optionen','help','modal'))
...
saveas(f_new, ['3_Results/',handles.Entwurf.Optionen.folder_id,'/2_Analysis/',handles.Plot.Auswahl_Plot,'_',handles.Entwurf.Optionen.file_id,'_v',num2str(handles.opt.Count)], 'fig');
close(f_new);
...
%        save (['3_Results/',handles.Entwurf.Optionen.folder_id,'/','2_Analysis/', 'KennfeldMaschine_Gesamtwirkungsgrad','.mat'],'KennfeldMaschine');
...
%         save (['3_Results/',handles.Entwurf.Optionen.folder_id,'/','2_Analysis/', KennfeldMaschineSpeichern.Entwurf.Optionen.Maschinentyp,'_',num2str(KennfeldMaschineSpeichern.Entwurf.Bemessungswerte.P_N/1000),'_',num2str(KennfeldMaschineSpeichern.Entwurf.Bemessungswerte.n_N),'_',num2str(KennfeldMaschineSpeichern.Analyse.Optionen.n_max),'_',num2str(KennfeldMaschineSpeichern.Entwurf.Bemessungswerte.U_N),'_','Kennfeld_Gesamtwirkungsgrad','.mat'],'Kennfeld_Gesamtwirkungsgrad');
...
%         save (['3_Results/',handles.Entwurf.Optionen.folder_id,'/','2_Analysis/', 'KennfeldMaschine_Verluste_gesamt','.mat'],'KennfeldMaschine_Verluste_gesamt');
...
%         save (['3_Results/',handles.Entwurf.Optionen.folder_id,'/','2_Analysis/', KennfeldMaschine_Verluste_gesamt_Speichern.Entwurf.Optionen.Maschinentyp,'_',num2str(KennfeldMaschine_Verluste_gesamt_Speichern.Entwurf.Bemessungswerte.P_N/1000),'_',num2str(KennfeldMaschine_Verluste_gesamt_Speichern.Entwurf.Bemessungswerte.n_N),'_',num2str(KennfeldMaschine_Verluste_gesamt_Speichern.Analyse.Optionen.n_max),'_',num2str(KennfeldMaschine_Verluste_gesamt_Speichern.Entwurf.Bemessungswerte.U_N),'_','Kennfeld_Gesamtverluste','.mat'],'Kennfeld_Gesamtverluste');
...
%         save (['3_Results/',handles.Entwurf.Optionen.folder_id,'/','2_Analysis/', 'KennfeldMaschine_Wirkungsgrad_Wicklungsverluste','.mat'],'KennfeldMaschine_Wirkungsgrad_Wicklungsverluste');
...
%         save (['3_Results/',handles.Entwurf.Optionen.folder_id,'/','2_Analysis/', 'KennfeldMaschine_Wicklungsverluste','.mat'],'KennfeldMaschine_Wicklungsverluste');
...
%         save (['3_Results/',handles.Entwurf.Optionen.folder_id,'/', '2_Analysis/', KennfeldMaschine_Wicklungsverluste_Speichern.Entwurf.Optionen.Maschinentyp,'_',num2str(KennfeldMaschine_Wicklungsverluste_Speichern.Entwurf.Bemessungswerte.P_N/1000),'_',num2str(KennfeldMaschine_Wicklungsverluste_Speichern.Entwurf.Bemessungswerte.n_N),'_',num2str(KennfeldMaschine_Wicklungsverluste_Speichern.Analyse.Optionen.n_max),'_',num2str(KennfeldMaschine_Wicklungsverluste_Speichern.Entwurf.Bemessungswerte.U_N),'_','Kennfeld_Wicklungsverluste','.mat'],'Kennfeld_Wicklungsverluste');
...
%         save (['3_Results/',handles.Entwurf.Optionen.folder_id,'/','2_Analysis/','KennfeldMaschine_Wirkungsgrad_Ummagnetisierungsverluste','.mat'],'KennfeldMaschine_Wirkungsgrad_Ummagnetisierungsverluste');
...
%         save (['3_Results/', handles.Entwurf.Optionen.folder_id,'/','2_Analysis/', 'KennfeldMaschine_Ummagnetisierungsverluste','.mat'],'KennfeldMaschine_Ummagnetisierungsverluste');
...
%         save (['3_Results/',handles.Entwurf.Optionen.folder_id,'/','2_Analysis/', 'KennfeldMaschine_WirkmechVerluste','.mat'],'KennfeldMaschine_WirkmechVerluste');
...
%         save (['3_Results/',handles.Entwurf.Optionen.folder_id,'/', '2_Analysis/', KennfeldMaschine_WirkmechVerluste_Speichern.Entwurf.Optionen.Maschinentyp,'_',num2str(KennfeldMaschine_WirkmechVerluste_Speichern.Entwurf.Bemessungswerte.P_N/1000),'_',num2str(KennfeldMaschine_WirkmechVerluste_Speichern.Entwurf.Bemessungswerte.n_N),'_',num2str(KennfeldMaschine_WirkmechVerluste_Speichern.Analyse.Optionen.n_max),'_',num2str(KennfeldMaschine_WirkmechVerluste_Speichern.Entwurf.Bemessungswerte.U_N),'_','Kennfeld_WirkmechVerluste','.mat'],'Kennfeld_WirkmechVerluste');
...
%         save (['3_Results/', handles.Entwurf.Optionen.folder_id,'/','2_Analysis/','KennfeldMaschine_mechVerluste','.mat'],'KennfeldMaschine_mechVerluste');
...
%         save (['3_Results/',handles.Entwurf.Optionen.folder_id,'/','2_Analysis/', 'KennfeldMaschine_WirkZusVerl','.mat'],'KennfeldMaschine_WirkZusVerl');
...
%         save (['3_Results/', handles.Entwurf.Optionen.folder_id,'/','2_Analysis/', 'KennfeldMaschine_ZusVerl','.mat'],'KennfeldMaschine_ZusVerl');
        ...
        Kennfeld_ZusVerl.T_max_n_axis = transpose(KennfeldMaschine_ZusVerl_Speichern.Analyse.Betriebsdaten.mot.M_vec);                                                          

%         save (['3_Results/',handles.Entwurf.Optionen.folder_id,'/','2_Analysis/', KennfeldMaschine_ZusVerl_Speichern.Entwurf.Optionen.Maschinentyp,'_',num2str(KennfeldMaschine_ZusVerl_Speichern.Entwurf.Bemessungswerte.P_N/1000),'_',num2str(KennfeldMaschine_ZusVerl_Speichern.Entwurf.Bemessungswerte.n_N),'_',num2str(KennfeldMaschine_ZusVerl_Speichern.Analyse.Optionen.n_max),'_',num2str(KennfeldMaschine_ZusVerl_Speichern.Entwurf.Bemessungswerte.U_N),'_','Kennfeld_ZusVerl','.mat'],'Kennfeld_ZusVerl');
...
%         save (['3_Results/',handles.Entwurf.Optionen.folder_id,'/','2_Analysis/', 'KennfeldMaschine_i_ld','.mat'],'KennfeldMaschine_i_ld');
...
%         save (['3_Results/',handles.Entwurf.Optionen.folder_id,'/','2_Analysis/', 'KennfeldMaschine_i_lq','.mat'],'KennfeldMaschine_i_lq');
...
%         save (['3_Results/',handles.Entwurf.Optionen.folder_id,'/','2_Analysis/', 'KennfeldMaschine_u_ld','.mat'],'KennfeldMaschine_u_ld');
...
%         save (['3_Results/',handles.Entwurf.Optionen.folder_id,'/','2_Analysis/', 'KennfeldMaschine_u_lq','.mat'],'KennfeldMaschine_u_lq');
        
    end


% --- Executes when uipanel_Eingabe is resized.
function uipanel_Eingabe_SizeChangedFcn(hObject, eventdata, handles)
% hObject    handle to uipanel_Eingabe (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
    handles.default_opt.n_max = 11400;
    handles.opt.n_max = handles.default_opt.n_max;
    handles.default_opt.n_tics = 160;
    handles.opt.n_tics = handles.default_opt.n_tics;
    handles.default_opt.M_tics = 160;
    handles.opt.M_tics = handles.default_opt.M_tics;
    handles.default_opt.u_1max = 600;                   
    handles.opt.u_1max = handles.default_opt.u_1max; 
    handles.default_opt.i_1max = 210;                   
    handles.opt.i_1max =  handles.default_opt.i_1max;
...
% --- Executes on button press in Model3_Analyse.
function Model3_Callback(hObject, eventdata, handles)
% hObject    handle to Model3_Analyse (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

    handles.default_opt.n_max = 17900;
    handles.opt.n_max = handles.default_opt.n_max;
    handles.default_opt.n_tics = 160;
    handles.opt.n_tics = handles.default_opt.n_tics;
    handles.default_opt.M_tics = 160;
    handles.opt.M_tics = handles.default_opt.M_tics;
    handles.default_opt.u_1max = 930;                   
    handles.opt.u_1max = handles.default_opt.u_1max; 
    handles.default_opt.i_1max = 210;                   
    handles.opt.i_1max =  handles.default_opt.i_1max;
...
% --- Executes on button press in NissanLeaf_Analyse.
function VW_eGolf_Callback(hObject, eventdata, handles)
% hObject    handle to NissanLeaf_Analyse (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
    ...
    handles.default_opt.M_tics = 160;
    handles.opt.M_tics = handles.default_opt.M_tics;
    handles.default_opt.u_1max = 610;                   %falsch
    handles.opt.u_1max = handles.default_opt.u_1max; 
    handles.default_opt.i_1max = 130;                   %falsch
    handles.opt.i_1max =  handles.default_opt.i_1max;
...
% handles    structure with handles and user data (see GUIDATA)
    ...
    handles.default_opt.n_max = 10390;
    handles.opt.n_max = handles.default_opt.n_max;
    handles.default_opt.n_tics = 160;
    handles.opt.n_tics = handles.default_opt.n_tics;
    handles.default_opt.M_tics = 160;
    handles.opt.M_tics = handles.default_opt.M_tics;
    handles.default_opt.u_1max = 620;                   
    handles.opt.u_1max = handles.default_opt.u_1max; 
    handles.default_opt.i_1max = 126;                  
    handles.opt.i_1max =  handles.default_opt.i_1max;
