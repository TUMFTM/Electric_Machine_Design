% -------------------------------------------------------------------------
% TU Muenchen - Lehrstuhl fuer Fahrzeugtechnik
% -------------------------------------------------------------------------
% Modell zur Auslegung einer permanentmagneterregten Synchronmaschine und
% anschliessender Wirkungsgradkennfeldberechnung
% -------------------------------------------------------------------------
% Autor:    Jonathan Erhard (jonathan.erhard@tum.de)
% Version:  v0.1 23.04.2018 - Erstellung (je)
%           v0.2 09.06.2018 - Input GUI hinzugefuegt (je)
%           v0.3 01.08.2018 - Literatur hinzugefuegt (je)
%           v0.4 03.09.2018 - final (je)
% -------------------------------------------------------------------------
